...
pub(crate) const PLAID_GITHUB_PAGES_COMPLETION_REDIRECT_URI: &str =
    "https://jessfraz.github.io/switchboard/plaid-complete/";
...
const AFTER_HELP: &str = concat!(
    ...
    "  plaid transactions sync --count 250\n",
    "  plaid cache transactions --limit 50\n",
    "  plaid institutions get-by-id ins_109508 --include-status --include-auth-metadata\n",
    "  plaid link token-create --client-user-id user-123 --product transactions --country-code US \\\n",
    "    --redirect-uri https://jessfraz.github.io/switchboard/plaid-callback/ --days-requested 180\n",
    "\n",
...
impl Error {
    fn render(&self, compact: bool) -> String {
        match self {
            ...
            Self::Cache(message) => render_json(&MessageErrorResponse::new("cache", message), compact),
